...
public class ImageLoader {
    ...
    private static final ThreadFactory sThreadFacotry = new ThreadFactory() {
    ...
    public static final Executor THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(CORE_POOL_SIZE, MAXIMUM_POOL_SIZE, KEEP_ALIVE, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(), sThreadFacotry);
    ...
    private void bindBitmap(String uri, ImageView imageView, final int reqWidth, final int reqHeight) {
    ...
    private Bitmap downloadBitmapFromUrl(String urlString) {
        ...
        try {
            ...
            bitmap= BitmapFactory.decodeStream(in);//这里要不要用option好呢
        } catch (IOException e) {
            e.printStackTrace();
        }finally {
    ...
    private Bitmap loadBitmapFromMemCache(String url) {
        return mMemoryCache.get(hashKeyFormUrl(url));
    }

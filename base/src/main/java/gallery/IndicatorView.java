 ...
 * Viewpager 页卡指示器，封装了指示器的切换
 * 和生成过程，可以根据viewPager 的 pager count 来生成指示灯的
 * 个数，并且通过Viewpager 的 viewPager 偏移量来动态的改变指示灯
 * 的位置，和当前选中的 view
 */
    ...
    * */
    ...
    public IndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (attr == R.styleable.IndicatorView_indicator_icon) {//通过自定义属性拿到指示器
